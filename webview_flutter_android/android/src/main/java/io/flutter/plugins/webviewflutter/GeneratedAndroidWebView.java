...
public class GeneratedAndroidWebView {
  ...
  public interface WebViewHostApi {
    ...
    void focusWebview(@NonNull Long instanceId);

    void hideKeyboardWebview(@NonNull Long instanceId);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebViewHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebViewHostApi.focusWebview", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number instanceIdArg = (Number) args.get(0);
                try {
                  api.focusWebview((instanceIdArg == null) ? null : instanceIdArg.longValue());
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebViewHostApi.hideKeyboardWebview", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number instanceIdArg = (Number) args.get(0);
                try {
                  api.hideKeyboardWebview((instanceIdArg == null) ? null : instanceIdArg.longValue());
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
